{% macro test_dq0__bon_cheq_separate__consistency_bonus_wo_cheque_null(model) %}
{% set model = '' %}
    ...
    select
        ...
        bns.bonus_wo_pk                  as bonus_wo_pk,
        bns.cheque_id                    as cheque_id,
        bns.bonus_wo_id                  as bonus_wo_id,
